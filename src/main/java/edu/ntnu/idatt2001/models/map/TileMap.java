...
public class TileMap implements Serializable {
    ...
    public TileMap(int tilePixelSize, int tileWidth, int tileHeight) {
        if (tilePixelSize <= 0) {
            throw new IllegalArgumentException("Tile Pixel Size can not be: " + tilePixelSize + ". Must be above 0.");
        }
        if (tileWidth <= 0) {
            throw new IllegalArgumentException("Tile Width can not be: " + tileWidth + ". Must be above 0.");
        }
        if (tileHeight <= 0) {
            throw new IllegalArgumentException("Tile height can not be: " + tileHeight + ". Must be above 0.");
        }
